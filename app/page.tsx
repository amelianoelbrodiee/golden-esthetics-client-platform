...
export default async function Home() {
  ...
  />
    ...
    <section className="about-preview shell"><div className="about-art"><span className="ge-mono">G</span><i className="ge-spark ge-spark-1">✦</i><i className="ge-spark ge-spark-2">✦</i><i className="ge-spark ge-spark-3">✦</i></div><div className="about-copy"><p className="eyebrow">Meet your esthetician</p><h2>Hi, I’m<br/><em>McKinnley.</em></h2><p>{content.aboutCopy}</p><a className="text-link" href="/about">More about McKinnley →</a></div></section>
