...
import { DaisyField, SunGlow } from "./components/GoldenDecals";
...
export default async function Home() {
  ...
  return <>
    ...
    <section className="hero shell"><SunGlow /><DaisyField variant="hero" /><div className="hero-copy"><p className="eyebrow">Golden Esthetics · Licensed Esthetician</p><h1>{headline.first}{headline.second && <><br/><em>{headline.second}</em></>}</h1><p className="lede">{content.heroSupportingCopy}</p><div className="button-row"><a className="button button-primary" href="/find-my-facial">Try Sparrow Skin Match <span>✦</span></a><a className="button button-quiet" href="/services">Explore services</a></div><div className="trust-row"><span>✦ Personalized care</span><span>✦ Thoughtful treatments</span><span>✦ A glow that feels like you</span></div></div><div className="hero-portrait"><div className="portrait-placeholder">
  <img
  ...
  />
    ...
    <section className="about-preview shell"><div className="about-art"><img className="ge-seal" src="/golden-seal.jpg" alt="Golden Esthetics monogram" /><i className="ge-spark ge-spark-1">✦</i><i className="ge-spark ge-spark-2">✦</i><i className="ge-spark ge-spark-3">✦</i></div><div className="about-copy"><p className="eyebrow">Meet your esthetician</p><h2>Hi, I’m<br/><em>McKinnley.</em></h2><p>{content.aboutCopy}</p><a className="text-link" href="/about">More about McKinnley →</a></div></section>
    ...
    <Testimonials/>
    <GoldenList/>
    <section className="booking-cta"><DaisyField variant="cta" /><div className="shell"><p className="eyebrow">Your glow is waiting</p><h2>Ready when you are.</h2><p>Choose your service and book directly with Golden Esthetics.</p><a className="button button-primary" href="https://golden-esthetics-101699.square.site/" target="_blank" rel="noreferrer">Book an Appointment ↗</a></div></section>
  </>;
}
