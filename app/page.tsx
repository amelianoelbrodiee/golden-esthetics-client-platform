...
export default async function Home() {
  ...
  return <>
    ...
    <section className="hero shell"><SunGlow /><HangingVine className="vine-hero-r" flip /><div className="hero-copy"><p className="eyebrow">Golden Esthetics · Licensed Esthetician</p><h1>{headline.first}{headline.second && <><br/><em>{headline.second}</em></>}</h1><p className="lede">{content.heroSupportingCopy}</p><div className="button-row"><a className="button button-primary" href="/find-my-facial">Try Sparrow Skin Match <span>✦</span></a><a className="button button-quiet" href="/services">Explore services</a></div><div className="trust-row"><span>✦ Personalized care</span><span>✦ Thoughtful treatments</span><span>✦ A glow that feels like you</span></div></div><div className="hero-portrait"><div className="portrait-placeholder">
  <img
