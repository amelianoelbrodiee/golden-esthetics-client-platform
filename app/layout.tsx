...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="en"><body><OpeningReveal /><Suspense fallback={null}><AnalyticsProvider /></Suspense>
    ...
    <main>{children}</main>
    <footer><div className="shell footer-grid"><div><a className="brand footer-brand" href="/"><span>Golden</span><small>Esthetics</small></a><p>Personalized skincare and beauty services by McKinnley Golden.</p></div><div><h3>Explore</h3><a href="/about">Meet McKinnley</a><a href="/services">Services</a><a href="/reviews">Reviews</a><a href="/find-my-facial">Sparrow Skin Match</a><a href="/gallery">Gallery</a><a href="/contact">Contact</a></div><div><h3>Connect</h3><a href={`mailto:${business.email}`}>{business.email}</a><a href={`tel:${business.phone.replace(/[^\d+]/g, "")}`}>{business.phone}</a><a href={business.instagramUrl} target="_blank" rel="noreferrer">{business.instagram} ↗</a></div><div><h3>Booking</h3><a href={business.squareBookingBaseUrl} target="_blank" rel="noreferrer">Book through Square ↗</a><p className="muted">Exact address and hours coming soon.</p></div></div><div className="shell footer-bottom"><span>© {new Date().getFullYear()} Golden Esthetics</span><a href="/privacy">Privacy</a><span>Powered by Sparrow</span></div></footer>
