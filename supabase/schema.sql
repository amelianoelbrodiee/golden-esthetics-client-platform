...
grant insert on public.consultations, public.booking_clicks, public.leads, public.newsletter_subscribers, public.analytics_events to anon;
...
create policy newsletter_public_insert on public.newsletter_subscribers for insert to anon with check (true);
